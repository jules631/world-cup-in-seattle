...
export const GLOBAL_SCHEDULE: Record<string, GlobalMatch[]> = {
  ...
  'Jun 28': [
    { id: 'r32-1', dateKey: 'Jun 28', team1: 'Canada', flag1: '🇨🇦', team2: 'South Africa', flag2: '🇿🇦', timePT: '12:00 PM', city: 'Los Angeles',  venue: 'SoFi Stadium',           isSeattle: false },
  ],
  'Jun 29': [
    { id: 'r32-2', dateKey: 'Jun 29', team1: 'Brazil',   flag1: '🇧🇷', team2: 'Japan',   flag2: '🇯🇵', timePT: '10:00 AM', city: 'Houston',   venue: 'NRG Stadium',      isSeattle: false },
    { id: 'r32-3', dateKey: 'Jun 29', team1: 'Paraguay', flag1: '🇵🇾', team2: 'Germany', flag2: '🇩🇪', timePT: '1:30 PM',  city: 'Boston',    venue: 'Gillette Stadium', isSeattle: false },
    { id: 'r32-4', dateKey: 'Jun 29', team1: 'Morocco',  flag1: '🇲🇦', team2: 'Netherlands', flag2: '🇳🇱', timePT: '6:00 PM', city: 'Monterrey', venue: 'Estadio BBVA',  isSeattle: false },
  ],
  'Jun 30': [
    { id: 'r32-5', dateKey: 'Jun 30', team1: 'Norway', flag1: '🇳🇴', team2: 'Ivory Coast', flag2: '🇨🇮', timePT: '10:00 AM', city: 'Dallas',       venue: 'AT&T Stadium',           isSeattle: false },
    { id: 'r32-6', dateKey: 'Jun 30', team1: 'France', flag1: '🇫🇷', team2: 'Sweden',      flag2: '🇸🇪', timePT: '2:00 PM',  city: 'New Jersey',   venue: 'MetLife Stadium',        isSeattle: false },
    { id: 'r32-7', dateKey: 'Jun 30', team1: 'Mexico', flag1: '🇲🇽', team2: 'Ecuador',     flag2: '🇪🇨', timePT: '6:00 PM',  city: 'Mexico City',  venue: 'Estadio Azteca',         isSeattle: false },
  ],
  'Jul 1': [
    { id: 'r32-8',  dateKey: 'Jul 1', team1: 'England', flag1: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', team2: 'DR Congo', flag2: '🇨🇩', timePT: '9:00 AM',  city: 'Atlanta',      venue: 'Mercedes-Benz Stadium',  isSeattle: false },
    { id: 'r32-9',  dateKey: 'Jul 1', team1: 'Belgium', flag1: '🇧🇪', team2: 'Senegal', flag2: '🇸🇳', timePT: '1:00 PM',  city: 'Seattle',      venue: 'Lumen Field',            isSeattle: true  },
    { id: 'r32-10', dateKey: 'Jul 1', team1: 'USA',     flag1: '🇺🇸', team2: 'Bosnia & Herzegovina', flag2: '🇧🇦', timePT: '5:00 PM',  city: 'San Francisco', venue: "Levi's Stadium",   isSeattle: false },
  ],
  'Jul 2': [
    { id: 'r32-11', dateKey: 'Jul 2', team1: 'Spain',       flag1: '🇪🇸', team2: 'Austria', flag2: '🇦🇹', timePT: '12:00 PM', city: 'Los Angeles',  venue: 'SoFi Stadium',           isSeattle: false },
    { id: 'r32-12', dateKey: 'Jul 2', team1: 'Portugal',    flag1: '🇵🇹', team2: 'Croatia', flag2: '🇭🇷', timePT: '4:00 PM',  city: 'Toronto',      venue: 'BMO Field',              isSeattle: false },
    { id: 'r32-13', dateKey: 'Jul 2', team1: 'Switzerland', flag1: '🇨🇭', team2: 'Algeria', flag2: '🇩🇿', timePT: '8:00 PM',  city: 'Vancouver',    venue: 'BC Place',               isSeattle: false },
  ],
  'Jul 3': [
    { id: 'r32-14', dateKey: 'Jul 3', team1: 'Egypt',     flag1: '🇪🇬', team2: 'Australia',  flag2: '🇦🇺', timePT: '11:00 AM', city: 'Dallas',       venue: 'AT&T Stadium',           isSeattle: false },
    { id: 'r32-15', dateKey: 'Jul 3', team1: 'Argentina', flag1: '🇦🇷', team2: 'Cape Verde', flag2: '🇨🇻', timePT: '3:00 PM',  city: 'Miami',        venue: 'Hard Rock Stadium',      isSeattle: false },
    { id: 'r32-16', dateKey: 'Jul 3', team1: 'Colombia',  flag1: '🇨🇴', team2: 'Ghana',      flag2: '🇬🇭', timePT: '6:30 PM',  city: 'Kansas City',  venue: 'Arrowhead Stadium',      isSeattle: false },
  ],
  // ── Round of 16 (Jul 4 – 7) ──────────────────────────────────
  'Jul 4': [
    { id: 'r16-1', dateKey: 'Jul 4', team1: 'Morocco', flag1: '🇲🇦', team2: 'Canada',   flag2: '🇨🇦', timePT: '10:00 AM', city: 'Houston',      venue: 'NRG Stadium',            isSeattle: false },
    { id: 'r16-2', dateKey: 'Jul 4', team1: 'France',  flag1: '🇫🇷', team2: 'Paraguay', flag2: '🇵🇾', timePT: '2:00 PM',  city: 'Philadelphia', venue: 'Lincoln Financial Field', isSeattle: false },
  ],
  'Jul 5': [
    { id: 'r16-3', dateKey: 'Jul 5', team1: 'Norway',  flag1: '🇳🇴', team2: 'Brazil', flag2: '🇧🇷', timePT: '1:00 PM',  city: 'New Jersey',   venue: 'MetLife Stadium',        isSeattle: false },
    { id: 'r16-4', dateKey: 'Jul 5', team1: 'England', flag1: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', team2: 'Mexico', flag2: '🇲🇽', timePT: '5:00 PM',  city: 'Mexico City',  venue: 'Estadio Azteca',         isSeattle: false },
  ],
  'Jul 6': [
    { id: 'r16-5', dateKey: 'Jul 6', team1: 'Spain', flag1: '🇪🇸', team2: 'Portugal', flag2: '🇵🇹', timePT: '12:00 PM', city: 'Dallas',       venue: 'AT&T Stadium',           isSeattle: false },
    { id: 'r16-6', dateKey: 'Jul 6', team1: 'USA',   flag1: '🇺🇸', team2: 'Belgium',  flag2: '🇧🇪', timePT: '2:00 PM',  city: 'Seattle',      venue: 'Lumen Field',            isSeattle: true  },
  ],
  'Jul 7': [
    { id: 'r16-7', dateKey: 'Jul 7', team1: 'Argentina',   flag1: '🇦🇷', team2: 'Egypt',    flag2: '🇪🇬', timePT: '9:00 AM',  city: 'Atlanta',      venue: 'Mercedes-Benz Stadium',  isSeattle: false },
    { id: 'r16-8', dateKey: 'Jul 7', team1: 'Switzerland', flag1: '🇨🇭', team2: 'Colombia', flag2: '🇨🇴', timePT: '1:00 PM',  city: 'Vancouver',    venue: 'BC Place',               isSeattle: false },
  ],
};
